...
import ca.ubc.cs.cpsc210.mindthegap.ArrivalBoardActivity;
...
public class ArrivalBoardListFragment extends ListFragment {
    ...
    public ArrayList<ArrivalBoard> getArrivalBoardsForSelectedStation() {
        ...
        ArrayList<ArrivalBoard> lstArrivalBoard = new ArrayList<>();

        for(ArrivalBoard next: current.getArrivalBoards()) {
            lstArrivalBoard.add(next);
        }

        return lstArrivalBoard;
